...
static int pcie_init(struct ieee80211_hw *hw)
{
	...
	pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].rx_desc_read = le32_to_cpu(get_hw_spec->rxpd_rd_ptr) & 0x0000ffff;
	pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].rx_desc_write = le32_to_cpu(get_hw_spec->rxpd_wr_ptr) & 0x0000ffff;
	...
	writel(pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].pphys_rx_ring,
	       pcie_priv->iobase0 + pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].rx_desc_read);
	writel(pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].pphys_rx_ring,
	       pcie_priv->iobase0 + pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].rx_desc_write);
	...
	set_hw_spec.rxpd_wr_ptr =  cpu_to_le32(pcie_priv->desc_data[PCIE_NUM_OF_DESC_DATA - 1].pphys_rx_ring);
