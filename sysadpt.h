...
#define SYSADPT_GROUPS_TX_QUEUES       1
//(SYSADPT_TOTAL_TX_QUEUES / SYSADPT_TX_WMM_QUEUES)

#define SYSADPT_TX_WK_QUEUES           (SYSADPT_GROUPS_TX_QUEUES * \
					SYSADPT_TX_WMM_QUEUES)
...
#define SYSADPT_AMSDU_ALLOW_SIZE       2304

#define SYSADPT_AMSDU_FLUSH_TIME       HZ

#define SYSADPT_AMSDU_FRAGMENT_THRESHOLD 28
